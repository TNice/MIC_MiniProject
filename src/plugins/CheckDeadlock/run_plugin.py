"""
This script is called by the plugin-wrapper, CheckDeadlock.js, which passes down the
...
from CheckDeadlock import CheckDeadlock
...
plugin = CheckDeadlock(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
